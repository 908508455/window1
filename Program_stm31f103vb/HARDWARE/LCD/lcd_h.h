...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD1端口定义---------------- 
#define	LCD1_LED PDout(3) //LCD1背光 	
...
void LCD1_Init(void);													   	//初始化
void LCD1_DisplayOn(void);													//开显示
void LCD1_DisplayOff(void);													//关显示
void LCD1_Clear(u16 Color);	 												//清屏
void LCD1_SetCursor(u16 Xpos, u16 Ypos);										//设置光标
void LCD1_DrawPoint(u16 x,u16 y);											//画点
//void LCD1_Fast_DrawPoint(u16 x,u16 y,u16 color);								//快速画点
u16  LCD1_ReadPoint(u16 x,u16 y); 											//读点 
void Draw_Circle(u16 x0,u16 y0,u8 r);										//画圆
void LCD1_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2);							//画线
void LCD1_DrawRectangle(u16 x1, u16 y1, u16 x2, u16 y2);		   				//画矩形
void LCD1_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);		   				//填充单色
void LCD1_Color_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 *color);				//填充指定颜色
void LCD1_ShowChar(u16 x,u16 y,char s,u8 size,u8 mode);						//显示一个字符
void LCM_Write_Word(u16 x,u16 y,u8 *gb,u8 size,u8 mode);

void LCD1_ShowNum(u16 x,u16 y,u32 num,u8 len,u8 size);  						//显示一个数字
void LCD1_ShowxNum(u16 x,u16 y,u32 num,u8 len,u8 size,u8 mode);				//显示 数字
void LCD1_ShowString(u16 x,u16 y,u8 size,u8 *p);		//显示一个字符串,12/16字体
...
//void LCD1_Scan_Dir(u8 dir);							//设置屏扫描方向
//void LCD1_Display_Dir(u8 dir);						//设置屏幕显示方向
void LCD1_Set_Window(u16 sx,u16 sy,u16 width,u16 height);//设置窗口		
